...
app_include_css = "/assets/contracting/css/easyai_theme_v10.css?v=16"
app_include_js = "/assets/contracting/js/easyai_theme_v10.js?v=16"

# include js, css files in header of web template
web_include_css = "/assets/contracting/css/easyai_theme_v10.css?v=16"
web_include_js = "/assets/contracting/js/easyai_theme_v10.js?v=16"
