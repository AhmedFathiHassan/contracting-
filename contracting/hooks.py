...
app_include_css = "/assets/contracting/css/easyai_theme_v10.css?v=23"
app_include_js = "/assets/contracting/js/easyai_theme_v10.js?v=23"

# include js, css files in header of web template
web_include_css = "/assets/contracting/css/easyai_theme_v10.css?v=23"
web_include_js = "/assets/contracting/js/easyai_theme_v10.js?v=23"
...
before_migrate = "contracting.permission_manager.migrate.restore_core_permission_manager_route"
